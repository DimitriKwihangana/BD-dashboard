...
function ClusteredBarchat1({ chartData, yTitle, xTitle, unit, legend, lgd}) {
  const options = {
    indexAxis: "y",
    responsive: true,
  ...
  return (
    <div  style={{ height: "300px", width: "680px", backgroundColor: 'white', padding:0  }}>
      ...
      <div className="chart-container" style={{ height: "280px", width: "700px", padding:0 , marginLeft:-20}}>
...
export default ClusteredBarchat1;
