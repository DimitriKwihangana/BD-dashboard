...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div>
      ...
      <div
        className={`fixed inset-0 bg-[#087ABC] bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar  lg:w-12 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-[#163547] p-4 transition-all duration-200 ease-in-out ${
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block text-white">Pages</span>
            </h3>
            <ul className="mt-3">
              {/* Dashboard */}
