...
function Active() {
  ...
  const submitted = projects.filter(project => project.status === "EOI" || project.status === "Competitive" || project.status === "GrantApplication" || project.status === "Singlesourcing"|| project.status === "Proposal");
